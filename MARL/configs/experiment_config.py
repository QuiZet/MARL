...
from MARL.configs.base_config import (
    InstantiateConfig,
    LoggingConfig,
    MachineConfig,
    ViewerConfig,
)
from MARL.configs.config_utils import to_immutable_dict
...
class ExperimentConfig(InstantiateConfig):
    ...
    relative_model_dir: Path = Path("relative_model_dir/")
    ...
    def set_experiment_name(self) -> None:
        ...
        if self.experiment_name is None:
            self.experiment_name = str(self.project).replace("../", "").replace("/", "-")
